import {fillExtrusionUniforms, fillExtrusionPatternUniforms, fillExtrusionUniformsNext} from './fill_extrusion_program';
...
export const programUniforms = {
    fillExtrusion: fillExtrusionUniformsNext,
