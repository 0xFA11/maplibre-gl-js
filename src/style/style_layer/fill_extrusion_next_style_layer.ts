...
export class FillExtrusionNextStyleLayer extends StyleLayer {
    ...
    createBucket(parameters: BucketParameters<FillExtrusionNextStyleLayer>) {
        return new FillExtrusionNextBucket(parameters);
    }
    ...
    queryIntersectsFeature(
        ...
        throw new Error("The queryIntersectsFeature haven't implemented yet.");
    }
}
